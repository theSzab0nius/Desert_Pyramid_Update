 ...
 */
public class NetheriteAlloyKhopeshItem extends SwordItem {

    // tweak these to taste
    private static final float ARMOR_DAMAGE_BONUS_PER_POINT = 0.21f; // +0.1 damage per armor point
    private static final float BASE_SWEEP_DAMAGE = 4.0f;            // damage dealt to swept mobs
    private static final double BASE_SWEEP_RANGE = 4.0d;            // sweep search radius

    public NetheriteAlloyKhopeshItem(ToolMaterial material, Settings settings) {
