 ...
 */
public class CopperAlloyKhopeshItem extends SwordItem {

    // tweak these to taste
    private static final float ARMOR_DAMAGE_BONUS_PER_POINT = 0.05f; // +0.1 damage per armor point
    private static final float BASE_SWEEP_DAMAGE = 2.0f;            // damage dealt to swept mobs
    private static final double BASE_SWEEP_RANGE = 3.0d;            // sweep search radius

    public CopperAlloyKhopeshItem(ToolMaterial material, Settings settings) {
