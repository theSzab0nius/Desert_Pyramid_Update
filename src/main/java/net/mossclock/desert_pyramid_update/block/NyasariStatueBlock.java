...
public class NyasariStatueBlock extends Block implements Waterloggable {

    public NyasariStatueBlock(Settings settings) {
        super(settings);
    ...
    public ActionResult onUse(BlockState state, World world, BlockPos pos, PlayerEntity player, BlockHitResult hit) {
        ...
        if (mainHand.isOf(Items.WHEAT) || mainHand.isOf(Items.WHEAT_SEEDS) || mainHand.isOf(Items.MELON_SLICE) ||
                offHand.isOf(Items.WHEAT) || offHand.isOf(Items.WHEAT_SEEDS) || offHand.isOf(Items.MELON_SLICE)) {
            ...
            if (!world.isClient) {
                ...
                if (Desert_pyramid_update.hasBlessing(serverPlayer, Blessing.BLESSING_OF_NYASARI)) {
                    Desert_pyramid_update.revokeBlessing(serverPlayer);
                } else {
                    Desert_pyramid_update.revokeBlessing(serverPlayer);
                    Desert_pyramid_update.grantBlessing(serverPlayer, Blessing.BLESSING_OF_NYASARI);

                    AdvancementUtils.grantIfFirstTime(serverPlayer, "blessing_of_nyasari");
