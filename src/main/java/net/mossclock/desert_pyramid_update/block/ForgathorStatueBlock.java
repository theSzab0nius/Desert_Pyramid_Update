...
public class ForgathorStatueBlock extends Block implements Waterloggable {

    public ForgathorStatueBlock(Settings settings) {
        super(settings);
    ...
    public ActionResult onUse(BlockState state, World world, BlockPos pos, PlayerEntity player, BlockHitResult hit) {
        ...
        if (mainHand.isOf(Items.RAW_IRON) || mainHand.isOf(Items.BREAD) || mainHand.isOf(Items.COAL) ||
                offHand.isOf(Items.RAW_IRON) || offHand.isOf(Items.BREAD) || offHand.isOf(Items.COAL)) {
            ...
            if (!world.isClient) {
                ...
                if (Desert_pyramid_update.hasBlessing(serverPlayer, Blessing.BLESSING_OF_FORGATHOR)) {
                    Desert_pyramid_update.revokeBlessing(serverPlayer);
                } else {
                    Desert_pyramid_update.revokeBlessing(serverPlayer);
                    Desert_pyramid_update.grantBlessing(serverPlayer, Blessing.BLESSING_OF_FORGATHOR);

                    AdvancementUtils.grantIfFirstTime(serverPlayer, "blessing_of_forgathor");
