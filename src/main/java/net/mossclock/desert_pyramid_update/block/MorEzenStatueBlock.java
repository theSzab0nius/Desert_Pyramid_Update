...
public class MorEzenStatueBlock extends Block implements Waterloggable {

    public MorEzenStatueBlock(Settings settings) {
        super(settings);
    ...
    public ActionResult onUse(BlockState state, World world, BlockPos pos, PlayerEntity player, BlockHitResult hit) {
        ...
        if (mainHand.isOf(Items.WHEAT) || mainHand.isOf(Items.APPLE) || mainHand.isOf(Items.COOKED_MUTTON) ||
                offHand.isOf(Items.WHEAT) || offHand.isOf(Items.APPLE) || offHand.isOf(Items.COOKED_MUTTON)) {
            ...
            if (!world.isClient) {
                ...
                if (Desert_pyramid_update.hasBlessing(serverPlayer, Blessing.BLESSING_OF_MOR_EZEN)) {
                    Desert_pyramid_update.revokeBlessing(serverPlayer);
                } else {
                    Desert_pyramid_update.revokeBlessing(serverPlayer);
                    Desert_pyramid_update.grantBlessing(serverPlayer, Blessing.BLESSING_OF_MOR_EZEN);

                    AdvancementUtils.grantIfFirstTime(serverPlayer, "blessing_of_mor_ezen");
