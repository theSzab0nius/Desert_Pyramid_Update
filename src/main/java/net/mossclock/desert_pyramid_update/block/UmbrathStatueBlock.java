...
public class UmbrathStatueBlock extends Block implements Waterloggable {

    public UmbrathStatueBlock(Settings settings) {
        super(settings);
    ...
    public ActionResult onUse(BlockState state, World world, BlockPos pos, PlayerEntity player, BlockHitResult hit) {
        ...
        if (mainHand.isOf(Items.DIAMOND) || mainHand.isOf(Items.INK_SAC) || mainHand.isOf(Items.FERMENTED_SPIDER_EYE) ||
                offHand.isOf(Items.DIAMOND) || offHand.isOf(Items.INK_SAC) || offHand.isOf(Items.FERMENTED_SPIDER_EYE)) {
            ...
            if (!world.isClient) {
                ...
                if (Desert_pyramid_update.hasBlessing(serverPlayer, Blessing.BLESSING_OF_UMBRATH)) {
                    Desert_pyramid_update.revokeBlessing(serverPlayer);
                } else {
                    Desert_pyramid_update.revokeBlessing(serverPlayer);
                    Desert_pyramid_update.grantBlessing(serverPlayer, Blessing.BLESSING_OF_UMBRATH);

                    AdvancementUtils.grantIfFirstTime(serverPlayer, "blessing_of_umbrath");
