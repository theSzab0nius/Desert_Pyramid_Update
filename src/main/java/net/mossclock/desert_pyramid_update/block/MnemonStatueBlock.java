...
public class MnemonStatueBlock extends Block implements Waterloggable {

    public MnemonStatueBlock(Settings settings) {
        super(settings);
    ...
    public ActionResult onUse(BlockState state, World world, BlockPos pos, PlayerEntity player, BlockHitResult hit) {
        ...
        if (mainHand.isOf(Items.WHEAT) || mainHand.isOf(Items.BOOK) || mainHand.isOf(Items.CHORUS_FRUIT) ||
                offHand.isOf(Items.WHEAT) || offHand.isOf(Items.BOOK) || offHand.isOf(Items.CHORUS_FRUIT)) {
            ...
            if (!world.isClient) {
                ...
                if (Desert_pyramid_update.hasBlessing(serverPlayer, Blessing.BLESSING_OF_MNEMON)) {
                    Desert_pyramid_update.revokeBlessing(serverPlayer);
                } else {
                    Desert_pyramid_update.revokeBlessing(serverPlayer);
                    Desert_pyramid_update.grantBlessing(serverPlayer, Blessing.BLESSING_OF_MNEMON);

                    AdvancementUtils.grantIfFirstTime(serverPlayer, "blessing_of_mnemon");
