...
public class KhertStatueBlock extends Block implements Waterloggable {

    public KhertStatueBlock(Settings settings) {
        super(settings);
    ...
    public ActionResult onUse(BlockState state, World world, BlockPos pos, PlayerEntity player, BlockHitResult hit) {
        ...
        if (mainHand.isOf(Items.WHEAT) || mainHand.isOf(Items.BREAD) || mainHand.isOf(Items.MELON_SLICE) ||
            ...
            if (!world.isClient) {
                ...
                if (Desert_pyramid_update.hasBlessing(serverPlayer, Blessing.BLESSING_OF_KHERT)) {
                    Desert_pyramid_update.revokeBlessing(serverPlayer);
                } else {
                    Desert_pyramid_update.revokeBlessing(serverPlayer);
                    Desert_pyramid_update.grantBlessing(serverPlayer, Blessing.BLESSING_OF_KHERT);

                    AdvancementUtils.grantIfFirstTime(serverPlayer, "blessing_of_khert");
