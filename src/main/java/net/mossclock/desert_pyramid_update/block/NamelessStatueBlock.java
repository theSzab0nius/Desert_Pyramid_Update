...
public class NamelessStatueBlock extends Block implements Waterloggable {

    public NamelessStatueBlock(Settings settings) {
        super(settings);
    ...
    public ActionResult onUse(BlockState state, World world, BlockPos pos, PlayerEntity player, BlockHitResult hit) {
        ...
        if (mainHand.isOf(Items.WHEAT) || mainHand.isOf(Items.BREAD) ||
                offHand.isOf(Items.WHEAT) || offHand.isOf(Items.BREAD)) {
