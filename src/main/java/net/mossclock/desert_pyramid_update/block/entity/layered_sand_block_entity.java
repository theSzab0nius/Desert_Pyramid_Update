...
import static net.mossclock.desert_pyramid_update.block.entity.ModBlockEntities.LAYERED_SAND_ENTITY_TYPE;
...
public class layered_sand_block_entity extends BlockEntity {
    ...
    public layered_sand_block_entity( BlockPos pos, BlockState state) {
        super(LAYERED_SAND_ENTITY_TYPE, pos, state);
    }
