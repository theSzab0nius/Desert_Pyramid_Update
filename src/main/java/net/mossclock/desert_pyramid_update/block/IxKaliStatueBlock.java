...
public class IxKaliStatueBlock extends Block implements Waterloggable {

    public IxKaliStatueBlock(Settings settings) {
        super(settings);
    ...
    public ActionResult onUse(BlockState state, World world, BlockPos pos, PlayerEntity player, BlockHitResult hit) {
        ...
        if (mainHand.isOf(Items.WHEAT) || mainHand.isOf(Items.GOLDEN_CARROT) || mainHand.isOf(Items.MELON_SLICE) ||
                offHand.isOf(Items.WHEAT) || offHand.isOf(Items.GOLDEN_CARROT) || offHand.isOf(Items.MELON_SLICE)) {
            ...
            if (!world.isClient) {
                ...
                if (Desert_pyramid_update.hasBlessing(serverPlayer, Blessing.BLESSING_OF_IXKALI)) {
                    Desert_pyramid_update.revokeBlessing(serverPlayer);
                } else {
                    Desert_pyramid_update.revokeBlessing(serverPlayer);
                    Desert_pyramid_update.grantBlessing(serverPlayer, Blessing.BLESSING_OF_IXKALI);

                    AdvancementUtils.grantIfFirstTime(serverPlayer, "blessing_of_ix_kali");
